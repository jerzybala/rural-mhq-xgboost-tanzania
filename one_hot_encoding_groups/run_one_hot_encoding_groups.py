"""
One-hot XGBoost runs for group-specific slices of the MHQ dataset.
Creates per-group outputs under one_hot_encoding_groups/<group_name>/.
"""
...
def save_outputs(job_dir: str, model, feature_importance, shap_importance, metrics):
    ...
    with open(os.path.join(job_dir, "xgboost_model_onehot.pkl"), "wb") as f:
        pickle.dump(model, f)
    ...
    with open(os.path.join(job_dir, "one_hot_encoding_results.pkl"), "wb") as f:
